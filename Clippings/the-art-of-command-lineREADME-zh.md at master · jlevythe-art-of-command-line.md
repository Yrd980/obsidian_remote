...
- [Meta](https://github.com/jlevy/the-art-of-command-line/blob/master/#meta)
- [Basics](https://github.com/jlevy/the-art-of-command-line/blob/master/#basics)
- [Everyday use](https://github.com/jlevy/the-art-of-command-line/blob/master/#everyday-use)
- [Processing files and data](https://github.com/jlevy/the-art-of-command-line/blob/master/#processing-files-and-data)
- [System debugging](https://github.com/jlevy/the-art-of-command-line/blob/master/#system-debugging)
- [One-liners](https://github.com/jlevy/the-art-of-command-line/blob/master/#one-liners)
- [Obscure but useful](https://github.com/jlevy/the-art-of-command-line/blob/master/#obscure-but-useful)
- [macOS only](https://github.com/jlevy/the-art-of-command-line/blob/master/#macos-only)
- [Windows only](https://github.com/jlevy/the-art-of-command-line/blob/master/#windows-only)
- [More resources](https://github.com/jlevy/the-art-of-command-line/blob/master/#more-resources)
- [Disclaimer](https://github.com/jlevy/the-art-of-command-line/blob/master/#disclaimer)
...
- This is written for Linux, with the exception of the "[macOS only](https://github.com/jlevy/the-art-of-command-line/blob/master/#macos-only)" and "[Windows only](https://github.com/jlevy/the-art-of-command-line/blob/master/#windows-only)" sections. Many of the other items apply or can be installed on other Unices or macOS (or even Cygwin).
...
- Know basic `awk` and `sed` for simple data munging. See [One-liners](https://github.com/jlevy/the-art-of-command-line/blob/master/#one-liners) for examples.
